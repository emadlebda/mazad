        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.posts.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('exterior_color') ? 'is-invalid' : '' }}" type="text"
                           name="exterior_color" id="exterior_color" value="{{ old('exterior_color', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('interior_color') ? 'is-invalid' : '' }}" type="text"
                           name="interior_color" id="interior_color" value="{{ old('interior_color', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('city_mpg') ? 'is-invalid' : '' }}" type="number"
                           name="city_mpg" id="city_mpg" value="{{ old('city_mpg', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('highway_mpg') ? 'is-invalid' : '' }}" type="number"
                           name="highway_mpg" id="highway_mpg" value="{{ old('highway_mpg', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('transmission') ? 'is-invalid' : '' }}" type="text"
                           name="transmission" id="transmission" value="{{ old('transmission', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('engine') ? 'is-invalid' : '' }}" type="text"
                           name="engine" id="engine" value="{{ old('engine', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('fuel_type') ? 'is-invalid' : '' }}" name="fuel_type"
                            id="fuel_type" required>
                        <option value
                                disabled {{ old('fuel_type', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                        @foreach(App\Models\Post::FUEL_TYPE_SELECT as $key => $label)
                            <option
                                value="{{ $key }}" {{ old('fuel_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                    ...
                    @foreach(App\Models\Post::STATUS_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status"
                                   value="{{ $key }}" {{ old('status', '0') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('category') ? 'is-invalid' : '' }}"
                        ...
                        @foreach($categories as $id => $entry)
                            <option
                                value="{{ $id }}" {{ old('category_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
