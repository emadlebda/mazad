...
{{--                <input class="form-control {{ $errors->has('orignal_price') ? 'is-invalid' : '' }}" type="number" name="orignal_price" id="orignal_price" value="{{ old('orignal_price', '') }}" step="0.01" required>--}}
