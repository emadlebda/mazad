...
{{--            </div>--}}
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exterior_color') ? 'is-invalid' : '' }}" type="text" name="exterior_color" id="exterior_color" value="{{ old('exterior_color', $post->exterior_color) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('interior_color') ? 'is-invalid' : '' }}" type="text" name="interior_color" id="interior_color" value="{{ old('interior_color', $post->interior_color) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city_mpg') ? 'is-invalid' : '' }}" type="number" name="city_mpg" id="city_mpg" value="{{ old('city_mpg', $post->city_mpg) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('highway_mpg') ? 'is-invalid' : '' }}" type="number" name="highway_mpg" id="highway_mpg" value="{{ old('highway_mpg', $post->highway_mpg) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transmission') ? 'is-invalid' : '' }}" type="text" name="transmission" id="transmission" value="{{ old('transmission', $post->transmission) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('engine') ? 'is-invalid' : '' }}" type="text" name="engine" id="engine" value="{{ old('engine', $post->engine) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('fuel_type') ? 'is-invalid' : '' }}" name="fuel_type" id="fuel_type" required>
                    ...
                    @foreach(App\Models\Post::FUEL_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('fuel_type', $post->fuel_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Post::STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $post->status) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('brand') ? 'is-invalid' : '' }}" name="brand_id" id="brand_id" required>
                    @foreach($brands as $id => $entry)
                        <option value="{{ $id }}" {{ (old('brand_id') ? old('brand_id') : $post->brand->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('brand'))
