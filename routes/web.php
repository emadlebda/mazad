...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth','CheckBanned']], function () {
    ...
    Route::get('users/{user}/change_status', 'UsersController@changeStatus')->name('users.changeStatus');
